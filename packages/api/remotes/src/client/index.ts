...
import subagentManagerRemote from '@deepseek-ai/dsh-host-subagent-manager/remote'
...
export type {
  ...
  SubagentBackendSource,
  SubagentToolEntry,
} from '@deepseek-ai/dsh-host-subagent-manager/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-inventory/remote'
export type {} from '@deepseek-ai/dsh-host-skill-manager/remote'
export type {} from '@deepseek-ai/dsh-host-subagent-manager/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, skillManagerRemote, subagentManagerRemote,
