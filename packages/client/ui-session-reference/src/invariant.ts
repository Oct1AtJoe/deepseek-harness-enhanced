...
/**
 * No runtime invariant: the '@' source is a registry-owned registration
 * whose disposal is proven by the HMR-safety spec. It emits no cordis
 * events and owns no cross-plugin mutable state beyond the session-scoped
 * candidate maps, which die with the plugin fiber.
 */
