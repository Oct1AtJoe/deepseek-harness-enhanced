...
export const zh = {
  ...
  'settings.when.petRedirect': '启用桌面桌宠时，通知由桌宠气泡接管，此处设置不再生效。',
...
export const en = {
  ...
  'settings.when.petRedirect': 'When the desktop pet is active, notifications are handled by the pet bubble; these settings no longer apply.',
