...
import { IconSparkle16, IconThinkOutline16 } from '@deepseek-ai/dsh-client-ui-primitives'
...
/** Cube order and icons: aurora the violet variant (sparkle), nebula the deep-space variant (orbit). */
const CUBES: readonly { id: 'aurora' | 'nebula'; labelKey: TechThemeKey; Icon: typeof IconSparkle16 }[] = [
