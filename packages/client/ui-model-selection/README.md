...
- **Effort memory is per Host** — the remembered effort lives in the Host settings document, so it follows the model across sessions and restarts but not across separate Hosts or user accounts.
