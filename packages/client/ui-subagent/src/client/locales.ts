...
export const zh = {
  ...
  'work.title': '子智能体工作台',
  'work.empty': '还没有子智能体',
  'work.emptyHint': '委派后台任务后，这里会实时显示子智能体的工作过程。',
  'work.refresh': '刷新',
  'work.running.one': '{count} 个正在运行',
  'work.running.other': '{count} 个正在运行',
  'work.open': '打开会话',
  'work.openHint': '点击打开子智能体会话，查看完整工作过程',
  'work.parent': '父会话',
  'button.label': '子智能体',
...
export const en: Record<SubagentKey, string> = {
  ...
  'work.title': 'Subagent work',
  'work.empty': 'No subagents yet',
  'work.emptyHint': 'Delegate a background task and its work will appear here live.',
  'work.refresh': 'Refresh',
  'work.running.one': '{count} running',
  'work.running.other': '{count} running',
  'work.open': 'Open conversation',
  'work.openHint': 'Click to open the subagent conversation and review its work',
  'work.parent': 'Parent session',
  'button.label': 'Subagents',
