...
import {
  ...
  sessionReferenceCandidatesValueSchema,
...
export interface IApiClient {
  sessions: {
    ...
    referenceCandidates(payload: RequestPayload<'session.referenceCandidates'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'session.referenceCandidates'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'session.referenceCandidates': sessionReferenceCandidatesValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    referenceCandidates: (payload, signal) => this.callUnary('session.referenceCandidates', payload, signal),
