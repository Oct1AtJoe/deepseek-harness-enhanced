...
- [应用的 diff hunk 只携带变更行](../bug-fix/2026-08-19-diff-hunks-carry-change-lines-only.zh.md) —— result view 的 hunk 只携带变更行；卡片直接从两段文本数出 `+A -R`。
