...
Source: [`packages/client/dsh-notification-custom/src/index.ts:22`](../packages/client/dsh-notification-custom/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-deliverables-custom` — requires `systemPrompt` ([`packages/client/ui-deliverables-custom/src/index.ts`](../packages/client/ui-deliverables-custom/src/index.ts))
...
- `@deepseek-ai/dsh-host-skill-manager` — requires `skills` · `settings` · `sessions` · `agents` · `agentPresets` ([`packages/host/skill-manager/src/index.ts`](../packages/host/skill-manager/src/index.ts))
- `@deepseek-ai/dsh-host-subagent-manager` — requires `loader` · `subagents` ([`packages/host/subagent-manager/src/index.ts`](../packages/host/subagent-manager/src/index.ts))
